...
namespace Sirenix.OdinInspector.Modules.UnityMathematics.Editor {
  ...
  public abstract class MatrixProcessor<T> : OdinAttributeProcessor<T> {
    ...
    public override void ProcessChildMemberAttributes(
        InspectorProperty parentProperty, MemberInfo member,
        List<Attribute> attributes) {
  ...
  public class Bool2Drawer : OdinValueDrawer<bool2> {
    ...
    protected override void DrawPropertyLayout(GUIContent label) {
              ...
              out labelRect);
      {
        ...
        var options
            = GUILayoutOptions.Height(EditorGUIUtility.singleLineHeight);

        GUIHelper.PushLabelWidth(SirenixEditorFields
  ...
  public class
      Float2Drawer : OdinValueDrawer<float2>, IDefinesGenericMenuItems {
    private bool isMatrixChild;
    protected override void Initialize() {
      isMatrixChild = Property.GetAttribute<MatrixChildAttribute>() != null;
    }
    ...
    public void PopulateGenericMenu(InspectorProperty property,
      ...
      genericMenu.AddItem(new GUIContent("Normalize"),
      ...
      genericMenu.AddItem(new GUIContent("Up", "Set the vector to (0, 1)"),
          vec == Vector2.up, () => SetVector(property, Vector2.up));
  ...
  public class
      Float3Drawer : OdinValueDrawer<float3>, IDefinesGenericMenuItems {
    private bool isMatrixChild;
    protected override void Initialize() {
      isMatrixChild = Property.GetAttribute<MatrixChildAttribute>() != null;
    }
  ...
  public class
      Float4Drawer : OdinValueDrawer<float4>, IDefinesGenericMenuItems {
    private bool isMatrixChild;
    protected override void Initialize() {
      isMatrixChild = Property.GetAttribute<MatrixChildAttribute>() != null;
    }
  ...
  public class Double2Drawer : OdinValueDrawer<double2>,
  ...
  public class Double3Drawer : OdinValueDrawer<double3>,
      IDefinesGenericMenuItems {
    private bool isMatrixChild;
    protected override void Initialize() {
      isMatrixChild = Property.GetAttribute<MatrixChildAttribute>() != null;
    ...
    private void SetVector(InspectorProperty property, Vector3 value) {
      property.Tree.DelayActionUntilRepaint(() => {
        for (var i = 0; i < property.ValueEntry.ValueCount; i++)
          property.ValueEntry.WeakValues[i]
              = new double3(value.x, value.y, value.z);
      });
    }
    private void NormalizeEntries(InspectorProperty property) {
      property.Tree.DelayActionUntilRepaint(() => {
  ...
  public class Double4Drawer : OdinValueDrawer<double4>,
      IDefinesGenericMenuItems {
    private bool isMatrixChild;
    protected override void Initialize() {
      isMatrixChild = Property.GetAttribute<MatrixChildAttribute>() != null;
    ...
    private void SetVector(InspectorProperty property, Vector4 value) {
      property.Tree.DelayActionUntilRepaint(() => {
        for (var i = 0; i < property.ValueEntry.ValueCount; i++)
          property.ValueEntry.WeakValues[i]
              = new double4(value.x, value.y, value.z, value.w);
      });
    }
    private void NormalizeEntries(InspectorProperty property) {
      property.Tree.DelayActionUntilRepaint(() => {
